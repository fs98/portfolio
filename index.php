		...
		<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0">
			...
			<div class="row mb-5">
				<div class="col-xl-6 col-lg-6 col-md-12">
					<p class="font-weight-300 text-grey">Web developer with Bachelor’s Degree in Information Technology. Experienced working as a PHP Developer building web applications, mostly APIs, using Laravel framework. I am currently focused on improving my frontend skills.</p>
					<h5 class="font-weight-600 skills-title mt-4 mb-5">My Top Skills</h5>
					<div class="progress-div">
						<p class="mb-2 text-grey font-weight-400">SKILL 1<span class="float-right">Very good</span></p>
					...
					<div class="progress-div">
						<p class="mb-2 text-grey font-weight-400">SKILL 2<span class="float-right">Very good</span></p>
						<div class="progress bg-white rounded-pill">
					...
					<div class="progress-div">
						<p class="mb-2 text-grey font-weight-400">SKILL 3<span class="float-right">Excellent</span></p>
						<div class="progress bg-white rounded-pill">
					...
					<div class="progress-div">
						<p class="mb-2 text-grey font-weight-400">SKILL 4<span class="float-right">Good</span></p>
						<div class="progress bg-white rounded-pill">
					...
					<div class="progress-div">
						<p class="mb-2 text-grey font-weight-400">SKILL 5<span class="float-right">Good</span></p>
						<div class="progress bg-white rounded-pill">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 mt-xl-0 mt-lg-0 mt-md-5 mt-sm-5 mt-5 d-flex justify-content-xl-end justify-content-lg-end justify-content-md-center justify-content-sm-center justify-content-center align-items-center">
					<div class="card mt-xl-0 mt-lg-0 mt-md-5 mt-sm-5 mt-5 border-0">
						<img src="assets/img/card-img-1.jpg" class="card-img-top rounded-0" alt="...">
		...
		<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0">
			...
			<div class="row mb-5 pt-5">
				...
				<div class="col-xl-6 col-lg-6 mt-5">
					<a class="project-title h5 font-weight-600 text-dark text-decoration-none" href="project.php">Hotel Website</a>
			...
			<div class="row mb-5  pt-5">
				...
				<div class="col-xl-6 col-lg-6 mt-5">
					<a class="project-title h5 font-weight-600 text-dark text-decoration-none" href="project.php">Foodblog</a>
			...
			<div class="row mb-5  pt-5">
				...
				<div class="col-xl-6 col-lg-6 mt-5">
					<a class="project-title h5 font-weight-600 text-dark text-decoration-none" href="project.php">Web Shop</a>
			...
			<div class="row my-5 pt-5">
				...
				<div class="col-xl-6 col-lg-6 mt-5">
					<a class="project-title h5 font-weight-600 text-dark text-decoration-none" href="project.php">Online gradebook</a>
