...
<body>
	...
	<section id="projectScreenshots">
		<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0  page-top">
			<div class="row py-5">
				<h1 class="text-center w-100 font-weight-600">Hotel Website</h1>
				<h6 class="text-center w-100 font-weight-300 text-grey mt-1 mx-3">One of the most important things for any business that is still in its infancy and looking for greener pastures is good web design. Web design can be that one thing that pushes you above or pulls you below the competition.</h6>
			</div>
			<div class="row mb-5">
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">

					<a href="https://picsum.photos/1200/600?random=1" data-fancybox="gallery" data-caption="Header">
						<img src="https://picsum.photos/1200/600?random=1" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=2" data-fancybox="gallery" data-caption="Review of the latest recipes">
						<img src="https://picsum.photos/1200/600?random=2" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=3" data-fancybox="gallery" data-caption="About Me">
						<img src="https://picsum.photos/1200/600?random=3" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=3" data-fancybox="gallery" data-caption="Recipe searching">
						<img src="https://picsum.photos/1200/600?random=4" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=5" data-fancybox="gallery" data-caption="Contact info">
						<img src="https://picsum.photos/1200/600?random=5" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=6" data-fancybox="gallery" data-caption="Sign in">
						<img src="https://picsum.photos/1200/600?random=6" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=7" data-fancybox="gallery" data-caption="Recipe details">
						<img src="https://picsum.photos/1200/600?random=7" class="img-fluid">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
					<a href="https://picsum.photos/1200/600?random=8" data-fancybox="gallery" data-caption="Recipe details">
						<img src="https://picsum.photos/1200/600?random=8" class="img-fluid">
					</a>
				</div>
			</div>
		</div>
		...
		<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0">
			<div class="row">
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<p class="text-grey font-weight-300 mt-4">Copyright &copy;<script>
							document.write(new Date().getFullYear());
						</script> Fata Sefer | All rights reserved</p>
