...
<section id="projectScreenshots">
	<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0  page-top">
		<div class="row py-5">
			<h1 class="text-center w-100 font-weight-600 mx-3">Academic Register</h1>
			<h6 class="text-center w-100 font-weight-300 text-grey mt-1 mx-3">This is a website where information is available on all registered universities and colleges in the state.</h6>
		</div>
    <div class="row mb-5">
    	<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-1.jpg" data-fancybox="gallery" data-caption="Header">
          <img src="../../assets/img/academic-register/academic-register-1.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-2.jpg" data-fancybox="gallery" data-caption="Review of the latest recipes">
          <img src="../../assets/img/academic-register/academic-register-2.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-3.jpg" data-fancybox="gallery" data-caption="Footer">
          <img src="../../assets/img/academic-register/academic-register-3.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-4.jpg" data-fancybox="gallery" data-caption="About Me">
          <img src="../../assets/img/academic-register/academic-register-4.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-5.jpg" data-fancybox="gallery" data-caption="Recipe searching">
          <img src="../../assets/img/academic-register/academic-register-5.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-6.jpg" data-fancybox="gallery" data-caption="Contact info">
		      <img src="../../assets/img/academic-register/academic-register-6.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/academic-register/academic-register-7.jpg" data-fancybox="gallery" data-caption="Sign in">
          <img src="../../assets/img/academic-register/academic-register-7.jpg" class="img-fluid"  alt="">
        </a>
      </div>
   </div>		
	</div>
