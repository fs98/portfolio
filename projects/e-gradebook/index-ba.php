...
<section id="aboutProject" class="bg-grey">
	<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0">
		<div class="row py-5">
			<h1 class="text-center w-100 font-weight-600">Školski informacioni sistem</h1>
			<h6 class="text-center w-100 font-weight-300 text-grey mt-1">Elektronski dnevnik</h6>
		</div>
		<div class="row">
			<div class="col-xl-6 col-lg-6 col-md-6 text-xl-left text-lg-left text-md-left text-sm-center text-center">
				...
				<h5 class="mt-4 service-title font-weight-600">Modul za administratora</h5>
				<p class="mt-4 font-weight-300 text-grey">Administrator predstavlja osobu koja je uposlenik škole i koji koordinira na koji način elektronski dnevnik funkcioniše i kako se upotrebljava. Kao najviša uloga u hijerarhiji sistemskih uloga u elektronskom dnevniku, ima mogućnost upravljanja svim informacijama, bez obzira na to ko je njihov vlasnik.</p>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 mt-xl-0 mx-lg-0 mt-md-0 mt-sm-4 mt-4 text-xl-left text-lg-left text-md-left text-sm-center text-center">
				...
				<h5 class="mt-4 service-title font-weight-600">Modul za sekretara</h5>
				<p class="mt-4 font-weight-300 text-grey">Najveći razlog kreiranja korisničkog profila za sekretara jeste preuzimanje potvrda o školovanju za sve učenike date škole.</p>
			</div>
		</div>
		<div class="row mt-4">
			<div class="col-xl-6 col-lg-6 col-md-6 text-xl-left text-lg-left text-md-left text-sm-center text-center">
				<i class="fas fa-chalkboard-teacher fa-3x" class="icon"></i>
				<h5 class="mt-4 service-title font-weight-600">Modul za nastavnika/razrednika</h5>
				<p class="mt-4 font-weight-300 text-grey">Nastavnik ima pristup i mogućnost upravljanja ocjenama učenika kojima predaje određeni predmet i obavještenjima različitog dometa. Razrednik ima pristup statistici koja će mu pomoći da napravi prijedlog izvještaja o uspjehu i vladanju učenika svog razreda, kao i da vidi i upravlja svim informacijama koje se tiču učenika njegovog razreda.</p>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 mt-xl-0 mx-lg-0 mt-md-0 mt-sm-4 mt-4 text-xl-left text-lg-left text-md-left text-sm-center text-center">
				<i class="fas fa-user-graduate fa-3x" class="icon"></i>
				<h5 class="mt-4 service-title font-weight-600">Modul za učenika/roditelja</h5>
				<p class="mt-4 font-weight-300 text-grey">Imaju mogućnost uvida u ocjene, vladanje, pohvale i ukore te izostanke i njihov trenutni status kao i razlog izostanka ukoliko je isti opravdan. Ovi korisnici imaju pristup odgovarajućim materijalima koje postavljaju predmetni nastavnici te obavijestima koje postavljaju ostali korisnici sistema.</p>
			</div>
		</div>
	</div>
</section>
		...
		<form method="post">
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-12 form-group d-flex flex-column justify-content-between">
				  <input type="text" class="form-control rounded-0 pl-3 mt-xl-0 mt-lg-0 mt-md-3 mt-sm-3 mt-3" maxlength="10" placeholder="Name" required="" name="visitorName">
	...
	<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0">
      ...
      mail($visitorEmail, $subject_visitorMail, $message_for_visitor, $headers);
			...
			<div class="col-xl-3 offset-xl-1 col-lg-3 offset-lg-1 col-md-6  mt-xl-0 mt-lg-0 mt-md-4 mt-sm-4 mt-5 col-sm-6">
				...
				<p class="font-weight-300 text-grey mt-3"><span><a href="https://www.facebook.com/fata.sefer" title="Facebook" target="_blank"><i class="fab fa-linkedin text-linkedin fa-lg mr-2"></i></a></span>Fata Sefer</p>
			</div>
		</div>
	</div>
</footer>
