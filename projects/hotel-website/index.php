...
<section id="projectScreenshots">
    ...
    <div class="row mb-5">
        ...
        <a href="../../assets/img/hotel-website/hotel-1.jpg" data-fancybox="gallery" data-caption="Header">
          <img src="../../assets/img/hotel-website/hotel-1.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-2.jpg" data-fancybox="gallery" data-caption="Review of the latest recipes">
          <img src="../../assets/img/hotel-website/hotel-2.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-4.jpg" data-fancybox="gallery" data-caption="About Me">
          <img src="../../assets/img/hotel-website/hotel-4.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-5.jpg" data-fancybox="gallery" data-caption="Recipe searching">
          <img src="../../assets/img/hotel-website/hotel-5.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-6.jpg" data-fancybox="gallery" data-caption="Contact info">
		      <img src="../../assets/img/hotel-website/hotel-6.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-7.jpg" data-fancybox="gallery" data-caption="Sign in">
          <img src="../../assets/img/hotel-website/hotel-7.jpg" class="img-fluid"  alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-8.jpg" data-fancybox="gallery" data-caption="Recipe details">
          <img src="../../assets/img/hotel-website/hotel-8.jpg" class="img-fluid"  alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/hotel-website/hotel-9.jpg" data-fancybox="gallery" data-caption="Recipe details">
          <img src="../../assets/img/hotel-website/hotel-9.jpg" class="img-fluid"  alt="">
        </a>
      </div>
   </div>		
	</div>
