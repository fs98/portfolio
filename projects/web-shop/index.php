...
<section id="projectScreenshots">
	<div class="container py-5 px-xl-0 px-lg-0 px-md-0 px-sm-0  page-top">
		<div class="row py-5">
			<h1 class="text-center w-100 font-weight-600">Web Shop</h1>
			<h6 class="text-center w-100 font-weight-300 text-grey mt-1 mx-3">Creating a webshop is becoming increasingly popular for many businesses. An online store or e-commerce store allows you to sell your products online to a global customer base.</h6>
		</div>
    <div class="row mb-5">
    	<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-1.jpg" data-fancybox="gallery" data-caption="Header">
          <img src="../../assets/img/web-shop/web-shop-1.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-2.jpg" data-fancybox="gallery" data-caption="Review of the latest recipes">
          <img src="../../assets/img/web-shop/web-shop-2.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-3.jpg" data-fancybox="gallery" data-caption="Footer">
          <img src="../../assets/img/web-shop/web-shop-3.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-4.jpg" data-fancybox="gallery" data-caption="About Me">
          <img src="../../assets/img/web-shop/web-shop-4.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-5.jpg" data-fancybox="gallery" data-caption="Recipe searching">
          <img src="../../assets/img/web-shop/web-shop-5.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-6.jpg" data-fancybox="gallery" data-caption="Contact info">
		      <img src="../../assets/img/web-shop/web-shop-6.jpg" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-7.jpg" data-fancybox="gallery" data-caption="Sign in">
          <img src="../../assets/img/web-shop/web-shop-7.jpg" class="img-fluid"  alt="">
        </a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
        <a href="../../assets/img/web-shop/web-shop-8.jpg" data-fancybox="gallery" data-caption="Recipe details">
          <img src="../../assets/img/web-shop/web-shop-8.jpg" class="img-fluid"  alt="">
        </a>
      </div>
   </div>		
	</div>
